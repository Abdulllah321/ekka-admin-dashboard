          ...
          <div className="modal-body">
            <div className="row">
              <div className="col-md-4">
                <img
                  src={
                    getImageUrl(selectedCategory.imageUrl!) || NoImageFound
                  }
              ...
              <div className="col-md-8">
                ...
                <div className="mb-3">
                  <p>
                    <strong className="text-dark">Short Description:</strong>{" "}
                    <span>{selectedCategory.shortDesc}</span>
                  </p>
                </div>
              ...
              <div className="mb-3">
                <p>
                  <strong className="text-dark">Full Description:</strong>{" "}
                  <span>{selectedCategory.fullDesc}</span>
                </p>
              </div>
            </div>
          </div>
